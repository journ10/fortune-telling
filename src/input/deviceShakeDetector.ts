...
export const SHAKE_START_THRESHOLD = DEFAULT_START_THRESHOLD;
export const SHAKE_STOP_THRESHOLD = DEFAULT_STOP_THRESHOLD;
export const SHAKE_QUIET_WINDOW_MS = DEFAULT_QUIET_WINDOW_MS;
